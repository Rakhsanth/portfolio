...
const dpImgWidth = dpImg.offsetWidth;
// console.log(dpImgSpeed);
const rToLMove = document.querySelectorAll('.rToLScroll');
const lToRMove = document.querySelectorAll('.lToRScroll');
...
// resuable JS code to make the edge popups responsive :)
const numbersInRow = 4;
const skillPops = document.querySelectorAll('.mySkills');
const aspSkillPops = document.querySelectorAll('.myAspSkills');
// for my skills
skillPops.forEach((popup, index) => {
    if (index % numbersInRow === 0) {
        console.log(popup, 0);
        popup.style.left = '100%';
    } else if (index % numbersInRow === 3) {
        popup.style.left = '0%';
        console.log(popup, 3);
    } else {
        popup.style.left = '50%';
...
aspSkillPops.forEach((popup, index) => {
    if (index % numbersInRow === 0) {
        popup.style.left = '100%';
        console.log(popup, 0);
    } else if (index % numbersInRow === 2) {
        popup.style.left = '0%';
        console.log(popup, 2);
    } else {
        popup.style.left = '50%';
